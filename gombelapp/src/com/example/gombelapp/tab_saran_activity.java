...
import com.example.gombelapp.tab_info_activity.AmbilData;
...
public class tab_saran_activity extends Activity {
	...
	public class AmbilData extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... arg0) {
			...
			try {	
			    ...
			    for (int i = 0; i < contacts.length(); i++) {
			    	...
			    	String user = c.getString("user").trim();
		...
		protected void onPostExecute(String result) {
		    ...
		    new String[] { "waktu","user", "judul","isi_saran", "id_saran" }, new int[] { R.id.waktu, R.id.user , R.id.judul, R.id.Isidetail, R.id.kode });
